...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $imageDir = '/uploads/';  // Absolute path to the directory
    ...
    // if everything is ok, try to upload file
      ...
      if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
        ...
        $employeeAdded = $employeeModel->createEmployee($name, $gender, $dob, $address, $phoneNumber, $email, $doj, $departmentId, $designationId, $imagePath);
      } else {
    ...
    <div class="container mb-5">
        ...
        <form  method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" id="phoneNumber" name="phoneNumber" placeholder="Enter phone number" pattern="[9876][0-9]{9}" title="Please enter a 10-digit phone number">
            </div>
            <div class="mb-3">
